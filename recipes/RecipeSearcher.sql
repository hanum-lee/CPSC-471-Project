...
DELIMITER ;;
CREATE PROCEDURE `addedit_cookware`(cookw json, rnum smallint(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `addedit_food`(foodname char(45), rnum smallint(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `addedit_ingredients`(ing_array json, rnum smallint(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `add_foodtype`(foodname varchar(45), foodtype varchar(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `edit_recipe`(rnum smallint(11), recname char(45),foodtype varchar(45), foodname char(45), tt int(11), dir text)
BEGIN
	update recipe
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `remove_ingredient`(rnum smallint(11), ingname varchar(45))
BEGIN
	delete from consists_of_ing
    where recipe_no = rnum 
		AND
